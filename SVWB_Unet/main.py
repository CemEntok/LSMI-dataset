...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_pool', type=str, default="default", choices=["default","multi","single","oneImage"]) # default means 1,2,3; custom means string naming image pool where to test the model
